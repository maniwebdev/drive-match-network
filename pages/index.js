...
const HomePage = () => {
  ...
  const handleSearch = async () => {
    ...
    try {
      ...
      const result = await searchPublicRides(searchFilters);
  ...
  const handleRideSelect = (rideId) => {
    if (!isAuthenticated) {
      ...
      // Directly go to details if authenticated
              ...
              <div className={styles.rideDetails}>
                ...
                <div className={styles.rideInfo}>
                  <div className={styles.infoItem}>
                    ...
                    <span>
                      {moment(ride.departureDateTime || ride.departureDate).format('MMM D, YYYY')}{' '}
                  ...
                  <div className={styles.infoItem}>
                    ...
                    <span>
                      Luggage: {ride.allowedLuggage || 'Not specified'}
                    </span>
                  </div>
                </div>
